...
{
    private static final Set<Item> TEMPTATION_ITEMS = Sets.newHashSet(ItemInit.chicken_ingot, ItemInit.chicken_diamond, Item.getItemFromBlock(BlockInit.chicken_block), Item.getItemFromBlock(BlockInit.chicken_diamond_block));
