package fr.flowarg.gunsofchickens.blocks.animation.chickenchest;
...
public class RenderChickenChest extends TileEntitySpecialRenderer<TileEntityChickenChest>
{
    ...
    @Override
    public void render(TileEntityChickenChest te, double x, double y, double z, float partialTicks, int destroyStage, float alpha)
    {
        GlStateManager.enableDepth();
        GlStateManager.depthFunc(515);
        GlStateManager.depthMask(true);

        ModelChickenChest model = MODEL;
