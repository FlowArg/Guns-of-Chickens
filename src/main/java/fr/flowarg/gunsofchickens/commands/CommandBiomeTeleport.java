...
public class CommandBiomeTeleport extends CommandBase
{
    private static final List<String> ALIASES = Lists.newArrayList(References.MODID, "tpbiome", "teleportbiome");
