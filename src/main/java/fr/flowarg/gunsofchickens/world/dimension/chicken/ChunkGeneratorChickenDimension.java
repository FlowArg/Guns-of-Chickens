...
public class ChunkGeneratorChickenDimension implements IChunkGenerator
{
    ...
    */
    ...
    public ChunkGeneratorChickenDimension(World world, boolean generate, long seed)
    {
        this.world = world;
    ...
    {
        double randY = rand.nextInt(150 - 1) + 1;
        this.rand.setSeed((long)x * 341873128712L + (long)z * 132897987541L);
        ChunkPrimer chunkprimer = new ChunkPrimer();
        BlockPos position = new BlockPos(x, randY, z);
        ...
        {
            abyte[i] = (byte)Biome.getIdForBiome(BiomeInit.CHICKEN_DIMENSION);
        }
